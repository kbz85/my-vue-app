...
module.exports = {
    theme: {
        colors: {
            ...
            'primary-color-disabled': 'rgb(var(--primary-color-disabled-tailwindcss) / <alpha-value>)',
            ...
            'success-color-disabled': 'rgb(var(--success-color-disabled-tailwindcss) / <alpha-value>)',
            ...
            'alarm-color-disabled': 'rgb(var(--alarm-color-disabled-tailwindcss) / <alpha-value>)',
            ...
            'warning-color-disabled': 'rgb(var(--warning-color-disabled-tailwindcss) / <alpha-value>)',
            ...
            'error-color-disabled': 'rgb(var(--error-color-disabled-tailwindcss) / <alpha-value>)',
            ...
            'info-color-disabled': 'rgb(var(--info-color-disabled-tailwindcss) / <alpha-value>)',
