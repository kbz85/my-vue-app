...
const matchStyle = (type) => {
  ...
  for (let index = 0; index < needTransparentColors.length; index++) {
    ...
    else if (type === "bg-" + element)
      return (arr = ["background-color", "bg"]);
    else if (type === "border-" + element)
      return (arr = ["border-color", "border"]);
    else {
      arr = null;
      return;
    }
...
module.exports = {
  theme: {
    colors: {
      ...
      "primary-color-hover":
        "rgb(var(--primary-color-hover-tailwindcss) / <alpha-value>)",
      "primary-color-active":
        "rgb(var(--primary-color-active-tailwindcss) / <alpha-value>)",
      "primary-color-disable":
        "rgb(var(--primary-color-disable-tailwindcss) / <alpha-value>)",
      "success-color": "rgb(var(--success-color-tailwindcss) / <alpha-value>)",
      "success-color-hover":
        "rgb(var(--success-color-hover-tailwindcss) / <alpha-value>)",
      "success-color-active":
        "rgb(var(--success-color-active-tailwindcss) / <alpha-value>)",
      "success-color-disable":
        "rgb(var(--success-color-disable-tailwindcss) / <alpha-value>)",
      "alarm-color": "rgb(var(--alarm-color-tailwindcss) / <alpha-value>)",
      "alarm-color-hover":
        "rgb(var(--alarm-color-hover-tailwindcss) / <alpha-value>)",
      "alarm-color-active":
        "rgb(var(--alarm-color-active-tailwindcss) / <alpha-value>)",
      "alarm-color-disable":
        "rgb(var(--alarm-color-disable-tailwindcss) / <alpha-value>)",
      "warning-color": "rgb(var(--warning-color-tailwindcss) / <alpha-value>)",
      "warning-color-hover":
        "rgb(var(--warning-color-hover-tailwindcss) / <alpha-value>)",
      "warning-color-active":
        "rgb(var(--warning-color-active-tailwindcss) / <alpha-value>)",
      "warning-color-disable":
        "rgb(var(--warning-color-disable-tailwindcss) / <alpha-value>)",
      "error-color": "rgb(var(--error-color-tailwindcss) / <alpha-value>)",
      "error-color-hover":
        "rgb(var(--error-color-hover-tailwindcss) / <alpha-value>)",
      "error-color-active":
        "rgb(var(--error-color-active-tailwindcss) / <alpha-value>)",
      "error-color-disable":
        "rgb(var(--error-color-disable-tailwindcss) / <alpha-value>)",
      "info-color": "rgb(var(--info-color-tailwindcss) / <alpha-value>)",
      "info-color-hover":
        "rgb(var(--info-color-hover-tailwindcss) / <alpha-value>)",
      "info-color-active":
        "rgb(var(--info-color-active-tailwindcss) / <alpha-value>)",
      "info-color-disable":
        "rgb(var(--info-color-disable-tailwindcss) / <alpha-value>)",
  ...
  plugins: [
    plugin(async function ({ addUtilities, theme }) {
