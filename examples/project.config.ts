 ...
 * @LastEditTime: 2023-05-30 15:38:14
 * @FilePath: \my-vue-app\examples\project.config.ts
...
export const lightTheme = {
    ...
    // 文字
    'text-title-color': '#000000d9', // 标题文字
    'text-color': '#000000a6', // 正文
    'text-secondary-color': '#00000073', // 次级文字
    'text-disabled-color': '#00000040', // 禁用型文字
    // 边框
    'border-base-color': '#00000026', // 边框1
    'border-light-color': '#0000000f', // 边框2
    'border-lighter-color': '#0000000a', // 边框3
    'border-extra-light-color': '#00000005', // 边框4
    //弹层/气泡弹框背景
    'tooltip-bg': '#ffffff',
    //弹层背景色
    'modal-bg': '#ffffff',
  ...
  export const darkTheme = {
    ...
    // 文字
    'text-title-color': '#ffffffd9', // 标题文字
    'text-color': '#ffffffa6', // 正文
    'text-secondary-color': '#ffffff73', // 次级文字
    'text-disabled-color': '#ffffff40', // 禁用型文字
    // 边框
    'border-base-color': '#ffffff40', // 边框1
    'border-light-color': '#ffffff33', // 边框2
    'border-lighter-color': '#ffffff1f', // 边框3
